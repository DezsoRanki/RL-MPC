...
% an array whose elements are the distance of the corresponding
% searchRegion points
...
% initial theta at the closetPoint descripted with length as theta
theta = traj_breaks(1,minIndex2);
% add the projection of the current position to the centerline
