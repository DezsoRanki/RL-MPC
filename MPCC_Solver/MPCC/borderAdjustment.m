...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% half width of the car with a safety boundary outside the car
...
% compute with the norm of the (x,y) position deviation of the first track point
...
for i = 1:length(track2.outer)
    ...
    % shrink track
    % schrink such that the track edge is the boundary of the center line of the car
